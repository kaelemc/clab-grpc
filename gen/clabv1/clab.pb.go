...
type ApplyRequest struct {
	...
	Runtime        string                 `protobuf:"bytes,2,opt,name=runtime,proto3" json:"runtime,omitempty"`
	TimeoutSeconds uint32                 `protobuf:"varint,3,opt,name=timeout_seconds,json=timeoutSeconds,proto3" json:"timeout_seconds,omitempty"`
	MaxWorkers     uint32                 `protobuf:"varint,4,opt,name=max_workers,json=maxWorkers,proto3" json:"max_workers,omitempty"`
	SkipPostDeploy bool                   `protobuf:"varint,5,opt,name=skip_post_deploy,json=skipPostDeploy,proto3" json:"skip_post_deploy,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ApplyRequest) GetTopologyYaml() []byte {
	if x != nil {
		return x.TopologyYaml
	}
	return nil
...
func (x *ApplyRequest) GetRuntime() string {
	if x != nil {
		return x.Runtime
	}
	return ""
...
func (x *ApplyRequest) GetTimeoutSeconds() uint32 {
	if x != nil {
		return x.TimeoutSeconds
	}
	return 0
...
func (x *ApplyRequest) GetMaxWorkers() uint32 {
	if x != nil {
		return x.MaxWorkers
	}
	return 0
...
func (x *ApplyRequest) GetSkipPostDeploy() bool {
	if x != nil {
		return x.SkipPostDeploy
	}
	return false
...
type ApplyResponse struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	LabName string                 `protobuf:"bytes,1,opt,name=lab_name,json=labName,proto3" json:"lab_name,omitempty"`
	// true when the lab was absent and got a full deploy
	DeployedLab       bool              `protobuf:"varint,2,opt,name=deployed_lab,json=deployedLab,proto3" json:"deployed_lab,omitempty"`
	AddedNodes        []string          `protobuf:"bytes,3,rep,name=added_nodes,json=addedNodes,proto3" json:"added_nodes,omitempty"`
	DeletedNodes      []string          `protobuf:"bytes,4,rep,name=deleted_nodes,json=deletedNodes,proto3" json:"deleted_nodes,omitempty"`
	RecreatedNodes    []string          `protobuf:"bytes,5,rep,name=recreated_nodes,json=recreatedNodes,proto3" json:"recreated_nodes,omitempty"`
	StartedNodes      []string          `protobuf:"bytes,6,rep,name=started_nodes,json=startedNodes,proto3" json:"started_nodes,omitempty"`
	RestartedNodes    []string          `protobuf:"bytes,7,rep,name=restarted_nodes,json=restartedNodes,proto3" json:"restarted_nodes,omitempty"`
	AddedLinks        []string          `protobuf:"bytes,8,rep,name=added_links,json=addedLinks,proto3" json:"added_links,omitempty"`
	DeletedEndpoints  []string          `protobuf:"bytes,9,rep,name=deleted_endpoints,json=deletedEndpoints,proto3" json:"deleted_endpoints,omitempty"`
	NodeChangeReasons map[string]string `protobuf:"bytes,10,rep,name=node_change_reasons,json=nodeChangeReasons,proto3" json:"node_change_reasons,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ApplyResponse) GetLabName() string {
	if x != nil {
		return x.LabName
	}
	return ""
...
func (x *ApplyResponse) GetDeployedLab() bool {
	if x != nil {
		return x.DeployedLab
	}
	return false
}

func (x *ApplyResponse) GetAddedNodes() []string {
	if x != nil {
		return x.AddedNodes
	}
	return nil
...
func (x *ApplyResponse) GetDeletedNodes() []string {
	if x != nil {
...
func (x *ApplyResponse) GetRecreatedNodes() []string {
	if x != nil {
		return x.RecreatedNodes
	}
	return nil
}

func (x *ApplyResponse) GetStartedNodes() []string {
	if x != nil {
		return x.StartedNodes
	}
	return nil
}

func (x *ApplyResponse) GetRestartedNodes() []string {
	if x != nil {
		return x.RestartedNodes
	}
	return nil
}

func (x *ApplyResponse) GetAddedLinks() []string {
	if x != nil {
		return x.AddedLinks
	}
	return nil
...
func (x *ApplyResponse) GetDeletedEndpoints() []string {
	if x != nil {
...
func (x *ApplyResponse) GetNodeChangeReasons() map[string]string {
	if x != nil {
		return x.NodeChangeReasons
	}
	return nil
}
...
func (x *StreamHostStatsRequest) Reset() {
	*x = StreamHostStatsRequest{}
	mi := &file_clab_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamHostStatsRequest) Descriptor() ([]byte, []int) {
	return file_clab_proto_rawDescGZIP(), []int{13}
}
...
func (x *HostStats) Reset() {
	*x = HostStats{}
	mi := &file_clab_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HostStats) Descriptor() ([]byte, []int) {
	return file_clab_proto_rawDescGZIP(), []int{14}
}
...
const file_clab_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"clab.proto\x12\aclab.v1\"\x8e\x02\n" +
	"\x04Node\x12\x12\n" +
	...
	"\vmax_workers\x18\x05 \x01(\rR\n" +
	"maxWorkers\x12\"\n" +
	"\rkeep_mgmt_net\x18\x06 \x01(\bR\vkeepMgmtNet\"\xc1\x01\n" +
	"\fApplyRequest\x12#\n" +
	"\rtopology_yaml\x18\x01 \x01(\fR\ftopologyYaml\x12\x18\n" +
	"\aruntime\x18\x02 \x01(\tR\aruntime\x12'\n" +
	"\x0ftimeout_seconds\x18\x03 \x01(\rR\x0etimeoutSeconds\x12\x1f\n" +
	"\vmax_workers\x18\x04 \x01(\rR\n" +
	"maxWorkers\x12(\n" +
	"\x10skip_post_deploy\x18\x05 \x01(\bR\x0eskipPostDeploy\"\xfd\x03\n" +
	"\rApplyResponse\x12\x19\n" +
	"\blab_name\x18\x01 \x01(\tR\alabName\x12!\n" +
	"\fdeployed_lab\x18\x02 \x01(\bR\vdeployedLab\x12\x1f\n" +
	"\vadded_nodes\x18\x03 \x03(\tR\n" +
	"addedNodes\x12#\n" +
	"\rdeleted_nodes\x18\x04 \x03(\tR\fdeletedNodes\x12'\n" +
	"\x0frecreated_nodes\x18\x05 \x03(\tR\x0erecreatedNodes\x12#\n" +
	"\rstarted_nodes\x18\x06 \x03(\tR\fstartedNodes\x12'\n" +
	"\x0frestarted_nodes\x18\a \x03(\tR\x0erestartedNodes\x12\x1f\n" +
	"\vadded_links\x18\b \x03(\tR\n" +
	"addedLinks\x12+\n" +
	"\x11deleted_endpoints\x18\t \x03(\tR\x10deletedEndpoints\x12]\n" +
	"\x13node_change_reasons\x18\n" +
	" \x03(\v2-.clab.v1.ApplyResponse.NodeChangeReasonsEntryR\x11nodeChangeReasons\x1aD\n" +
	"\x16NodeChangeReasonsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\bhostname\x18\v \x01(\tR\bhostname2\xe7\x03\n" +
	"\fContainerlab\x123\n" +
	...
	"\bRedeploy\x12\x18.clab.v1.RedeployRequest\x1a\x11.clab.v1.LabState\x126\n" +
	"\x05Apply\x12\x15.clab.v1.ApplyRequest\x1a\x16.clab.v1.ApplyResponse\x125\n" +
...
var file_clab_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_clab_proto_goTypes = []any{
	...
	(*ApplyRequest)(nil),           // 6: clab.v1.ApplyRequest
	(*ApplyResponse)(nil),          // 7: clab.v1.ApplyResponse
	(*InspectRequest)(nil),         // 8: clab.v1.InspectRequest
	(*ExecRequest)(nil),            // 9: clab.v1.ExecRequest
	(*ExecResult)(nil),             // 10: clab.v1.ExecResult
	(*ExecResponse)(nil),           // 11: clab.v1.ExecResponse
	(*HostStatsRequest)(nil),       // 12: clab.v1.HostStatsRequest
	(*StreamHostStatsRequest)(nil), // 13: clab.v1.StreamHostStatsRequest
	(*HostStats)(nil),              // 14: clab.v1.HostStats
	nil,                            // 15: clab.v1.Node.LabelsEntry
	nil,                            // 16: clab.v1.ApplyResponse.NodeChangeReasonsEntry
}
var file_clab_proto_depIdxs = []int32{
	15, // 0: clab.v1.Node.labels:type_name -> clab.v1.Node.LabelsEntry
	0,  // 1: clab.v1.LabState.nodes:type_name -> clab.v1.Node
	16, // 2: clab.v1.ApplyResponse.node_change_reasons:type_name -> clab.v1.ApplyResponse.NodeChangeReasonsEntry
	10, // 3: clab.v1.ExecResponse.results:type_name -> clab.v1.ExecResult
	2,  // 4: clab.v1.Containerlab.Deploy:input_type -> clab.v1.DeployRequest
	3,  // 5: clab.v1.Containerlab.Destroy:input_type -> clab.v1.DestroyRequest
	5,  // 6: clab.v1.Containerlab.Redeploy:input_type -> clab.v1.RedeployRequest
	6,  // 7: clab.v1.Containerlab.Apply:input_type -> clab.v1.ApplyRequest
	8,  // 8: clab.v1.Containerlab.Inspect:input_type -> clab.v1.InspectRequest
	9,  // 9: clab.v1.Containerlab.Exec:input_type -> clab.v1.ExecRequest
	12, // 10: clab.v1.Containerlab.GetHostStats:input_type -> clab.v1.HostStatsRequest
	13, // 11: clab.v1.Containerlab.StreamHostStats:input_type -> clab.v1.StreamHostStatsRequest
	1,  // 12: clab.v1.Containerlab.Deploy:output_type -> clab.v1.LabState
	4,  // 13: clab.v1.Containerlab.Destroy:output_type -> clab.v1.DestroyResponse
	1,  // 14: clab.v1.Containerlab.Redeploy:output_type -> clab.v1.LabState
	7,  // 15: clab.v1.Containerlab.Apply:output_type -> clab.v1.ApplyResponse
	1,  // 16: clab.v1.Containerlab.Inspect:output_type -> clab.v1.LabState
	11, // 17: clab.v1.Containerlab.Exec:output_type -> clab.v1.ExecResponse
	14, // 18: clab.v1.Containerlab.GetHostStats:output_type -> clab.v1.HostStats
	14, // 19: clab.v1.Containerlab.StreamHostStats:output_type -> clab.v1.HostStats
